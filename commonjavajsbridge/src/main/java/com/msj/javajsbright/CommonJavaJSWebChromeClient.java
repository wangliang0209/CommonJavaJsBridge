 ...
 * @desc
 *该类的主要作用是在{@link #onJsPrompt(WebView, String, String, String, JsPromptResult)}对js传递的数据交给{@link CommonJavaJsBridge}进行
 ...
 */
public class CommonJavaJSWebChromeClient extends WebChromeClient {
    ...
    private CommonJavaJsBridge mCommonJavaJsBridge;

    CommonJavaJSWebChromeClient(WebChromeClient webChromeClient, CommonJavaJsBridge commonJavaJsBridge) {
        mWebChromeClient = webChromeClient;
        mCommonJavaJsBridge = commonJavaJsBridge;
    }
...
//        result.cancel();
    ...
    public boolean onJsPrompt(WebView view, String url, String message, String defaultValue, JsPromptResult result) {
        if (mCommonJavaJsBridge.parseJsonFromJs(message)) {
